...
add_action('wp_ajax_nopriv_dcms_buscar_plato_rand','dcms_buscar_plato_rand');
add_action('wp_ajax_dcms_buscar_plato_rand','dcms_buscar_plato_rand');

function dcms_buscar_plato_rand()
{
    ...
    $result = $_short->FromBuscarPlatoRand($id_part_day,$id_dish);
    echo $result;
...
add_action('wp_ajax_nopriv_dcms_ajax_delete_dish','dcms_delete_dish');
add_action('wp_ajax_dcms_ajax_delete_dish','dcms_delete_dish');
function dcms_delete_dish()
{
    ...
    $result = $_short->formEliminarDish($datos); // formActualizarDish
    echo $result ;
	wp_die();
...
add_action('wp_ajax_nopriv_dcms_ajax_cambiar_menu_week_det','dcms_cambiar_menu_week_det');
add_action('wp_ajax_dcms_ajax_cambiar_menu_week_det','dcms_cambiar_menu_week_det');
function dcms_cambiar_menu_week_det()
{
    $html="fdddd";
   $_short = new menu_plan;
    ...
    $result = $_short->GetRecomPlato($obj->ids_dish,$obj->id_part_day,$obj->id_dish);

    $obj_recom = json_decode($result);

    $result2=$_short->InsertarMenuWeekDet($obj->id_menu_week,$obj_recom->id_dish,$obj->date_menu,$obj->id_part_day,$obj->id_day);
...
//shortcode que carga la primera vez
