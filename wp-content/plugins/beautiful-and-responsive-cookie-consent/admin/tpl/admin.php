...
<?php if ($displayReview === true) {?>
  ...
  <img id="nsc_bar_notice_please_rate_image" width="150px" src="<?php echo NSC_BAR_PLUGIN_URL ?>/admin/img/rating-stars.png"/>
            <p>Do you enjoy this free plugin? Say "Thank You" with a 5 star review. It takes only a couple of minutes, and it has an amazing effect on the happiness of the plugin developer.</p>
            <p target="_blank" class="nsc_bar_notice_links">
              <a id="nsc_bar_notice_link_one" target="_blank" class="button button-primary" href="https://wordpress.org/support/plugin/beautiful-and-responsive-cookie-consent/reviews/#new-post">Yes, I want to support</a>
              <a id="nsc_bar_notice_reviewedAlready" class="nsc_bar_notice_link_two" href="#">I reviewed already</a>
            </p>
  </div>
<?php }?>
